      ...
      <el-scrollbar style="width: 80%; height: 70%">
        <el-form :model="user" style="width: 80% text-align:center" :rules="rules" ref="registerRef">
          ...
          <el-row>
            ...
            <el-col :span="8">
              <el-form-item>
                <el-button plain type="primary" style="width: 100%" @click="EventSendVerifyCode" v-bind:disabled="DisableVerifycodeButton">
          ...
          <div style="display: flex">
            <div style="flex: 1; text-align: left">
              已经有账号：请
              <span style="color: rgb(92, 214, 92); cursor: pointer" @click="$emit('have-account-login')">登录</span>
            </div>
          </div>
        </el-form>
      </el-scrollbar>
