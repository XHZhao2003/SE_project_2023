<template>
    ...
    <div style="position: absolute; top: 0%; left: 0%; width: 100%; height: 100px; z-index: 1;">
        <el-menu :default-active="activeIndex" class="el-menu-demo" mode="horizontal" :ellipsis="false"
            @select="handleSelect" style="background-color: aliceblue; height: 100%;">
            ...
            <div style="display: flex; flex-direction: row; flex-grow: 1; justify-content: flex-end;">
                <el-menu-item index="1" style="height: 100%; width: 10%; font-size: 28px;"
                @click="switchToLogin"
                >登录</el-menu-item>
                <el-menu-item index="2" style="height: 100%; width: 10%; font-size: 28px;"
